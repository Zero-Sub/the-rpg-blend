...
- **Validation status:** source reviewed; environment validation pending
...
| Member | Partition | Separate data set within a database file | Do not assume every SQL table design uses multiple members |
...
3. Record three database objects and their types.
...
- Use catalog metadata as evidence rather than relying on memory about an object's definition.
...
3. What is the difference between a row and metadata about the table?
4. Why is a logical file not always equivalent to an SQL view?
5. What does an index primarily provide?
6. Why should modernization documentation preserve both old and new vocabulary?

## Completion Criteria

The learner can translate the core terminology, inspect schema metadata, and explain at least two places where a simplistic one-to-one mapping can mislead.
...
See M2-SUP-01, M2-SUP-04, M2-IBM-01, and M2-IBM-06 in the source register.
